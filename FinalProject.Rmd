...
said strategy. Note that performance is actually better when people report not using a normatively ineffective 
strategy (e.g., rote rehearsal or passive reading) than when they report using these strategies.") +
